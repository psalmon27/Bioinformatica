# -*- coding: utf-8 -*-
"""
Created on Sun Oct  2 23:50:55 2022
...
#Creo el archivo con las alineaciones
secuencias_aln=MuscleCommandline(input="secuencias.fasta")
print(secuencias_aln)

#Parseo el archivo output generado
for secuencias_aln in SeqIO.parse("secuencias.fasta","fasta"):
    print(secuencias_aln.id)
    print(repr(secuencias_aln.seq))
    print(len(secuencias_aln))

#Genero un archivo FASTA del output
SeqIO.write(secuencias_aln,"secuencias_aln.fasta","fasta")